...
public class FindEntityTest extends FunctionalTestBase {
    ...
    public static void publishTestMessages() {
        publishMessagesToDB(ImmutableList.of(
                "{\"hash\":\"hash1\",\"entry\":{\"name\":\"ellis\",\"ft_presentation\":\"12345\"}}",
                "{\"hash\":\"hash2\",\"entry\":{\"name\":\"presley\",\"ft_presentation\":\"6789\"}}",
                "{\"hash\":\"hash3\",\"entry\":{\"name\":\"ellis\",\"ft_presentation\":\"145678\"}}"
        ));
    ...
    public void findByPrimaryKey_shouldReturnEntryWithThPrimaryKey() {
        Response response = getRequest("/ft_presentation/12345.json");

        assertThat(response.readEntity(String.class), equalTo("{\"hash\":\"hash1\",\"entry\":{\"name\":\"ellis\",\"ft_presentation\":\"12345\"}}"));
    }
    ...
    public void findByHash_shouldReturnEntryForTheGivenHash() throws IOException {
        ...
        assertThat(OBJECT_MAPPER.readValue(response.readEntity(String.class), JsonNode.class),
                equalTo(OBJECT_MAPPER.readValue("{\"hash\":\"hash2\",\"entry\":{\"name\":\"presley\",\"ft_presentation\":\"6789\"}}", JsonNode.class)));
    }
    ...
    public void all_shouldReturnAllCurrentVersionsOnly() throws InterruptedException, IOException {
        ...
        assertThat(OBJECT_MAPPER.readValue(jsonResponse, JsonNode.class),
                equalTo(OBJECT_MAPPER.readValue("[{\"hash\":\"hash2\",\"entry\":{\"name\":\"presley\",\"ft_presentation\":\"6789\"}},{\"hash\":\"hash3\",\"entry\":{\"name\":\"ellis\",\"ft_presentation\":\"145678\"}},{\"hash\":\"hash1\",\"entry\":{\"name\":\"ellis\",\"ft_presentation\":\"12345\"}}]", JsonNode.class)));
    }
    ...
    public void search_returnsAllMatchingEntries() {
        ...
        assertThat(response.readEntity(String.class), equalTo(
                "[{\"hash\":\"hash3\",\"entry\":{\"name\":\"ellis\",\"ft_presentation\":\"145678\"}},{\"hash\":\"hash1\",\"entry\":{\"name\":\"ellis\",\"ft_presentation\":\"12345\"}}]"
        ));
    }
    ...
    public void search_returnsAllEntriesWhenNoSearchQueryIsGiven() {
        ...
        assertThat(response.readEntity(String.class), equalTo(
                "[{\"hash\":\"hash2\",\"entry\":{\"name\":\"presley\",\"ft_presentation\":\"6789\"}},{\"hash\":\"hash3\",\"entry\":{\"name\":\"ellis\",\"ft_presentation\":\"145678\"}},{\"hash\":\"hash1\",\"entry\":{\"name\":\"ellis\",\"ft_presentation\":\"12345\"}}]"
        ));
    }
